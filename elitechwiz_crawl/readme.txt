...
The first three files are mendetory for the elitechwiz scanner. These files have the list of files and directories which the scanner uses for crawling.
